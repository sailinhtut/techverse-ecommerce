                        ...
                        <div class="collapse collapse-arrow p-0 m-0 py-0">
                            ...
                            <div class="collapse-content m-0 pl-5">
                                <ul class="w-full space-y-1">
                                    ...
                                    <li><a href="{{ route('admin.dashboard.order.shipping-setting.get') }}"
                                            class="{{ request()->is('admin/dashboard/order.shippingadmin.dashboard.order.shipping-setting.get') ? 'bg-primary text-primary-content' : '' }}">Shipping
                                            Methods</a>
                                    </li>
                                    <li><a href="{{ route('admin.dashboard.order.payment-setting.get') }}"
                                            class="{{ request()->is('admin/dashboard/order.payment-setting') ? 'bg-primary text-primary-content' : '' }}">Payment
                                            Methods</a>
                                    </li>
                                    <li><a href="{{ route('admin.dashboard.order.tax-setting.get') }}"
                                            class="{{ request()->is('admin/dashboard/order.tax-setting') ? 'bg-primary text-primary-content' : '' }}">Tax
                                            Methods</a>
                                    </li>
                    ...
                    <div class="collapse collapse-arrow p-0 m-0">
                        ...
                        <div class="collapse-content m-0 pl-5">
                            <ul class="w-full space-y-1">
                                ...
                                <li><a href="{{ route('admin.dashboard.order.shipping-setting.get') }}"
                                        class="{{ request()->is('admin/dashboard/order/shipping-setting') ? 'bg-primary text-primary-content' : '' }}">Shipping
                                        Methods</a></li>
                                <li><a href="{{ route('admin.dashboard.order.payment-setting.get') }}"
                                        class="{{ request()->is('admin/dashboard/order/payment-setting') ? 'bg-primary text-primary-content' : '' }}">Payment
                                        Methods</a></li>
