...
@section('web_content')
    ...
    <div class="p-4 md:p-5 lg:p-7 mx-auto">
        <div class="mb-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div class="flex flex-col lg:p-10" x-data="productVariantData()">
                            ...
                            <div class="w-10">
                                <input class="input join-item -z-10" name="quantity"
                                    :value="$store.cart.items[{{ $product['id'] }}] ?
                                        ...
                                        0"
                                    min="1" :max="variantProduct.stock" readonly />
                            </div>

                            <button type="button" class="btn join-item" @click='addVariantItemToCart()'>
                                Add to Cart
                            </button>
                        </div>
                ...
                <div class="tab-content">
                    <div class="mt-5 min-h-[300px]">
                        @if (!empty($product['long_description']))
                            <div class="whitespace-pre-wrap">{{ $product['long_description'] }}</div>
                        @else
                    ...
                    <div class="w-full flex flex-col items-start mt-5">
                        ...
                        <div class="mt-5 w-full">
                            ...
                            <form
                                ...
                                $el.submit();
                            "
                                action='{{ route('shop.review.post') }}' method='POST' enctype='multipart/form-data'
                                ...
                                <div>
                                    ...
                                    <div class="rating rating-sm rating-half">
                                        <input type="radio" x-model="rating" name="rating" class="rating-hidden" />
                                        ...
                                        <div class="flex items-start gap-4">
                                            ...
                                            <div class="flex-1">
                                                <div class="flex justify-between items-start">
                                                    <div class="flex flex-col gap-2">
                                                        <div
                                                            ...
                                                            <h3
                                                                ...
                                                                <span x-text="review.user?.name ?? 'Unknown User'"></span>
                                                            </h3>
                                                        ...
                                                        <div class="mt-1 rating rating-xs rating-half">
                                                            <template x-for="rate in [0.5,1,1.5,2,2.5,3,3.5,4,4.5,5]"
                                                                ...
                                                                <input disabled type="radio"
                                                                    :name="'rating-' + review.id" :value="rate"
                                                    ...
                                                    <div class="flex flex-col md:flex-row md:items-start items-end gap-2">
                                                        ...
                                                        <dialog :id="`review_delete_modal_${review.id}`" class="modal">
                                                            <div class="modal-box">
                                                                <form method="dialog">
                                                                    <button
                                                                        class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
                                                                    ...
                                                                    <div class="flex items-start gap-2">
                                                                        ...
                                                                        <dialog :id="`reply_delete_modal_${reply.id}`"
                                                                            ...
                                                                            <div class="modal-box">
                                                                                ...
                                                                                <p class="text-lg font-semibold">Confirm
                                                                                    Delete</p>
                                                                                <p class="text-sm mb-4">Are you sure you
                                                                                    want to delete
                                                                                    this reply by
                                                                                    <span class="text-error"
...
@push('script')
    <script>
        ...
        function scrollController() {
            return {
                scrollAmount: 200, // adjust scroll distance per click
                prev() {
        ...
        function productVariantData() {
            return {
                ...
                addItemToCart() {
                    let existingItem = this.$store.cart.items[this.product_id];
                    let pendingQuantity = (existingItem?.quantity ?? 0) + 1;

                    if (this.product.enable_stock && pendingQuantity > this.product.stock) {
                        Toast.show("No More Stock");
                        this.$store.cart.deleteItem(this.product_id);
                        return;
                    }
                ...
                addVariantItemToCart() {
                    if (!this.variantProduct) {
                        Toast.show("Please select a valid variant.");
                        return;
                    }
                    ...
                    if ((existingItem && existingItem.variant_id != this.variantProduct.id)) {
                        Toast.show("Deleted Old Variant Cart Item");
                        this.$store.cart.deleteItem(this.product_id);

                    }

                    if (this.variantProduct.enable_stock && pendingQuantity > this.variantProduct.stock) {
                        Toast.show("No More Stock");
                        this.$store.cart.deleteItem(this.product_id);
                        return;
                    }
                    ...
                    this.$store.cart.addItem({
                        id: this.product_id,
                        variant_id: this.variantProduct.id,
                        variant_combination: this.variantProduct.combination ?? null,
                        name: @json($product['name']),
                        slug: @json($product['slug']),
                        sku: this.variantProduct.sku,
                        price: this.variantProduct.sale_price ?? this.variantProduct.regular_price,
                        image: this.variantProduct.image ?? null,
                        quantity: 1
                    });
